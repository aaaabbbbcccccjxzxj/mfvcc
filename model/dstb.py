...
class DenseSblock(nn.Module):
    ...
    def __init__(self, in_channel, reduce_ratio=8) -> None:
        ...
        self.convp4 = nn.Conv2d(in_channel // reduce_ratio * 3 + in_channel, in_channel, 1)
        ...
        self.conv_7 = nn.Conv2d(in_channel // 2, in_channel // reduce_ratio, 3, dilation=3, padding='same')
...
class DenseTblock(nn.Module):
    ...
    def __init__(self, in_channel, reduce_ratio=8) -> None:
        ...
        self.convp4 = nn.Conv3d(in_channel // reduce_ratio * 3 + in_channel, in_channel, (1, 1, 1))
        ...
        self.conv_7 = nn.Conv3d(in_channel // 2, in_channel // reduce_ratio, (3, 1, 1), dilation=3, padding='same')
